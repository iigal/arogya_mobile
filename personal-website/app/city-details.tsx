  ...
  const handleActionPress = (action: { id: number; title: string; icon: string; color: string; }) => {
    ...
    switch (action.id) {
      case 1: // Symptoms & Transmission
        router.push({
          pathname: '/city-symptoms',
          params: routeParams
        });
        break;
      case 2: // Preventive Measures
        router.push({
          pathname: '/city-preventive',
          params: routeParams
        });
        break;
      case 3: // Treatment Guidelines
        router.push({
          pathname: '/city-treatment',
          params: routeParams
        });
        break;
      case 4: // Vaccination Information
        router.push({
          pathname: '/city-vaccination',
          params: routeParams
        });
        break;
      default:
        router.push('/disease-info');
    }
  };
          ...
          <View style={styles.diseaseCard}>
            ...
            <View style={styles.statusRow}>
              <View style={styles.statusItem}>
                ...
                <Text style={styles.statusLabel}>Transmission</Text>
              </View>
              <View style={styles.statusItem}>
                <Ionicons name="checkmark-circle" size={24} color="#10b981" />
                <Text style={styles.statusLabel}>Preventive</Text>
